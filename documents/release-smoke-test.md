...
**Build under test:** _(fill in: commit hash / release tag / date)_
**Tester:** _(your handle)_
**API tokens used:** _(Replicate — which plan? anything unusual about the account?)_
...
|----------|-------|-------|
| First launch after install: SmartScreen click-through | ⬜ | "More info → Run anyway" |
