...
public sealed class AnthropicTokenStore : IAnthropicTokenStore
{
    private const string TokenStorageKey = "imggen.anthropic_token";
    private static readonly TimeSpan DebounceDelay = TimeSpan.FromMilliseconds(500);

    private readonly ILogger<AnthropicTokenStore> _logger;
    private readonly ISecureStorage _secureStorage;
    private readonly DebouncedSecureStorageWriter _writer;

    public AnthropicTokenStore(ILogger<AnthropicTokenStore> logger, ISecureStorage? secureStorage = null)
    {
    ...
    public async Task<string?> LoadAsync()
    {
        ...
        {
            _logger.LogWarning(ex, "Anthropic SecureStorage.{Op} failed", "Get");
            return null;
        }
    }
    ...
    public void Forget()
    {
        ...
        {
            _logger.LogWarning(ex, "Anthropic SecureStorage.{Op} failed", "Remove");
        }
    }
