...
public sealed class CivitaiTokenStore : ICivitaiTokenStore
{
    private const string TokenStorageKey = "imggen.civitai_token";
    private static readonly TimeSpan DebounceDelay = TimeSpan.FromMilliseconds(500);

    private readonly ILogger<CivitaiTokenStore> _logger;
    private readonly ISecureStorage _secureStorage;
    private readonly DebouncedSecureStorageWriter _writer;

    public CivitaiTokenStore(ILogger<CivitaiTokenStore> logger, ISecureStorage? secureStorage = null)
    {
    ...
    public async Task<string?> LoadAsync()
    {
        ...
        {
            _logger.LogWarning(ex, "CivitAI SecureStorage.{Op} failed", "Get");
            return null;
        }
    }
    ...
    public void Forget()
    {
        ...
        {
            _logger.LogWarning(ex, "CivitAI SecureStorage.{Op} failed", "Remove");
        }
    }
